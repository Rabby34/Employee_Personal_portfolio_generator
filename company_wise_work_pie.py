...
fig1, ax1 = plt.subplots(figsize=(4.7,4.7),facecolor='#011936')
wedges,labelss=ax1.pie(data, labels=label_array_of_data,
...
plt.tight_layout()
# plt.show()
plt.savefig('./images/company_wise_work_hour_pie.png', transparent=False)
